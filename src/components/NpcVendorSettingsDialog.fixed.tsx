  ...
  const vendorStockSections = [
    {
      ...
      tooltip: 'Use an existing item group as Constant Stock.',
      buttonTooltip: 'Create a vendor-specific Constant Stock group and open it for editing.',
    },
    {
      title: 'Status Stock',
      ...
      tooltip: 'Use an existing item group as Status Stock.',
      buttonTooltip: 'Create a vendor-specific Status Stock group and open it for editing.',
    },
    {
      title: 'Random Stock',
      ...
      buttonTooltip: 'Create a vendor-specific Random Stock group and open it for editing.',
    },
  ] as const;
