...
declare global {
  interface Window {
    electronAPI: {
      ...
      saveExportFiles: (projectPath: string, mapName: string, mapTxt: string, tilesetDef: string, options?: { spawn?: { enabled: boolean; content: string; filename?: string }; tilesetImages?: Record<string, string>; npcFiles?: Array<{ filename: string; content: string }>; portraitFiles?: Array<{ sourcePath: string; destFilename: string }>; npcTilesetImages?: Array<{ sourcePath: string; destFilename: string }>; npcAnimationFiles?: Array<{ filename: string; content: string }> }) => Promise<{ success: boolean; message?: string; validation?: { success: boolean; fileResults: Array<{ filePath: string; category: string | null; errors: string[]; warnings: string[] }> } }>;
